...
export const news: NewsItem[] = [
  ...
  },
  {
    ...
    body: `
      <p>A SaferNet Brasil registrou em 2025 um aumento expressivo nas denúncias de <strong>grooming</strong> (aliciamento online de menores) em plataformas de jogos como Roblox, Fortnite e Discord.</p>
