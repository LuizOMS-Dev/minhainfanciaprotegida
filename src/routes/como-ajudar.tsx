...
const steps = [
  {
    ...
    icon: Ear,
    title: "Escute",
    text: "Pare tudo o que estiver fazendo. Olhe nos olhos. Deixe a criança falar no tempo dela, sem interromper e sem fazer perguntas indutivas.",
  },
  {
    n: "02",
    icon: Heart,
    title: "Acolha",
    text: "Diga que você acredita, que ela não tem culpa e que fez certo em contar. O acolhimento é o primeiro ato de proteção.",
  },
  {
    n: "03",
    icon: Sparkles,
    title: "Não julgue",
    text: "Evite expressões de horror, raiva ou descrença diante da criança. Não confronte o suposto agressor por conta própria.",
  },
  {
    n: "04",
    icon: Shield,
    title: "Proteja",
    text: "Garanta que a criança esteja em ambiente seguro, afastada do agressor. Procure o Conselho Tutelar e, se necessário, atendimento médico.",
  },
  {
    n: "05",
    icon: ShieldCheck,
    title: "Denuncie",
    text: "Acione o Disque 100, a Polícia (190) e o Conselho Tutelar. A denúncia pode ser anônima e a investigação é dever do Estado.",
  },
];
      ...
      <section className="py-20 sm:py-28 bg-background">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="O que fazer diante de uma suspeita ou revelação"
          />
            ...
            {steps.map((s, i) => (
              <Reveal key={s.n} delay={i * 80} as="li">
                <article className="group relative rounded-3xl border border-border bg-card p-8 sm:p-10 hover-lift grid sm:grid-cols-[auto_1fr_auto] gap-6 items-start">
                  <span className="font-display text-6xl sm:text-7xl font-semibold text-[color:var(--orange)]/30 leading-none">
                    {s.n}
                  </span>
                  <div>
                  ...
                  <div
                    className="h-1.5 w-16 rounded-full bg-gradient-orange self-center hidden sm:block"
                    aria-hidden
                  />
                </article>
              </Reveal>
              ...
              <ul className="mt-4 grid sm:grid-cols-2 gap-3 text-sm text-foreground/85">
                {[
                  ...
                  <li key={t} className="flex gap-2">
                    <span className="text-[color:var(--red-inst)] font-bold">×</span>
                    {t}
                  </li>
                ))}
              </ul>
        ...
        <div className="mx-auto max-w-3xl px-4">
          <Reveal>
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <a
                href="tel:100"
                className="inline-flex items-center gap-2 rounded-full bg-[color:var(--orange)] text-[color:var(--navy-deep)] px-7 py-3 font-bold"
              >
                <Phone className="size-5" /> Ligar 100
              </a>
              <Link
                to="/denuncia"
                className="inline-flex items-center gap-2 rounded-full border border-white/40 px-7 py-3 font-semibold hover:bg-white/10"
              >
                Ver todos os canais
              </Link>
            </div>
