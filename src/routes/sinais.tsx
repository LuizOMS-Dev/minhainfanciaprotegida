  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Identificar Sinais de Abuso" },
      {
        ...
        content: "Comportamentos que merecem atenção segundo UNICEF e Childhood Brasil.",
      },
...
const signs = [
  {
    icon: Sparkles,
    title: "Mudanças bruscas de comportamento",
    desc: "Alterações repentinas de humor, agressividade ou apatia sem causa aparente.",
  },
  {
    icon: AlertTriangle,
    title: "Medos incomuns",
    desc: "Medo excessivo de uma pessoa específica, de lugares ou de ficar sozinho.",
  },
  {
    icon: UserMinus,
    title: "Isolamento",
    desc: "Afastamento de amigos, familiares e atividades que antes gostava.",
  },
  {
    icon: GraduationCap,
    title: "Queda no rendimento escolar",
    desc: "Dificuldade súbita de concentração, faltas e queda nas notas.",
  },
  {
    icon: Brain,
    title: "Ansiedade",
    desc: "Inquietação, dores de cabeça e de estômago recorrentes sem causa médica.",
  },
  {
    icon: CloudRain,
    title: "Tristeza excessiva",
    desc: "Choro frequente, desânimo persistente e sintomas depressivos.",
  },
  {
    icon: Frown,
    title: "Comportamentos regressivos",
    desc: "Voltar a fazer xixi na cama, chupar dedo ou falar como bebê após já ter superado.",
  },
  {
    icon: Lock,
    title: "Segredos e silêncio",
    desc: "Demonstra ter um segredo importante envolvendo um adulto e demonstra culpa ou vergonha.",
  },
  {
    icon: Waves,
    title: "Conhecimento sexual incompatível",
    desc: "Demonstra conhecimento ou comportamento sexual além do esperado para a idade.",
  },
];
    ...
    <>
      <section className="relative isolate overflow-hidden bg-[color:var(--navy-deep)] text-white py-20 sm:py-28">
        <div
          ...
          style={{
            backgroundImage: `url(${listeningImg})`,
        ...
        />
        <div
          className="absolute inset-0 -z-10 bg-gradient-to-r from-[color:var(--navy-deep)] via-[color:var(--navy-deep)]/85 to-transparent"
          aria-hidden
        />
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em]">
              <AlertTriangle className="size-3.5 text-[color:var(--orange)]" /> Atenção · Sinais de
              alerta
            </span>
          </Reveal>
          <Reveal delay={120}>
            ...
            {signs.map((s, i) => (
              <Reveal key={s.title} delay={i * 60}>
                <article className="group h-full rounded-2xl border border-border bg-card p-6 hover-lift relative overflow-hidden">
                  <div
                    className="absolute -right-12 -top-12 size-32 rounded-full bg-[color:var(--orange)]/10 transition-transform duration-700 group-hover:scale-125"
                    aria-hidden
                  />
          ...
          <Reveal delay={200}>
            <p className="mt-10 text-xs text-muted-foreground max-w-3xl">
              ...
              <a
                ...
                href="https://www.unicef.org/brazil/protecao-de-criancas-e-adolescentes"
                target="_blank"
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <Reveal>
            ...
            <p className="mt-3 text-white/90 max-w-2xl mx-auto">
              Não espere ter certeza. A denúncia é anônima e quem investiga é a autoridade
              competente.
            </p>
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              <a
                href="tel:100"
                className="inline-flex items-center gap-2 rounded-full bg-white text-[color:var(--red-inst)] px-7 py-3 font-bold"
              >
                <Phone className="size-5" /> Ligar 100
              </a>
              <Link
                to="/denuncia"
                className="inline-flex items-center gap-2 rounded-full border border-white/60 px-7 py-3 font-semibold hover:bg-white/10"
              >
                Outros canais
              </Link>
            </div>
