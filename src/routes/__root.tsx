      ...
      <div className="flex min-h-[70vh] flex-col items-center justify-center bg-background px-4 py-16">
        <div className="max-w-xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link
              to="/"
              className="inline-flex items-center justify-center rounded-full bg-[color:var(--orange)] px-6 py-3 text-sm font-bold text-[color:var(--navy-deep)] hover:opacity-95 transition shadow-sm"
            >
              Voltar para o início
            </Link>
            <Link
              to="/biblioteca"
              className="inline-flex items-center justify-center rounded-full border border-border bg-card px-6 py-3 text-sm font-semibold text-foreground hover:bg-muted transition shadow-sm"
            >
              Acessar Biblioteca
            </Link>
            <Link
