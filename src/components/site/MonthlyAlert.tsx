...
const ALERTS = [
  {
    month: 0,
    title: "Grooming",
    desc: "Como adultos abordam crianças online se passando por amigos.",
    to: "/riscos-online" as const,
  },
  {
    month: 1,
    title: "Discord — riscos invisíveis",
    desc: "Servidores abertos, DMs e exposição de menores na plataforma.",
    to: "/riscos-online" as const,
  },
  {
    month: 2,
    title: "Roblox — o que os pais precisam saber",
    desc: "Configurações de segurança, chat e contatos com estranhos.",
    to: "/pais" as const,
  },
  {
    month: 3,
    title: "Cyberbullying",
    desc: "Ataques digitais, humilhação pública e impacto na saúde mental.",
    to: "/riscos-online" as const,
  },
  {
    month: 4,
    title: "Maio Laranja",
    desc: "Mês nacional de combate à violência sexual contra crianças.",
    to: "/maio-laranja" as const,
  },
  {
    month: 5,
    title: "Compartilhamento de imagens",
    desc: "Riscos de fotos de crianças expostas em redes sociais.",
    to: "/pais" as const,
  },
  {
    month: 6,
    title: "Jogos online",
    desc: "Mecânicas predatórias, lives e contato com adultos desconhecidos.",
    to: "/riscos-online" as const,
  },
  {
    month: 7,
    title: "Redes sociais",
    desc: "Conta restrita, idade mínima e o que monitorar nas plataformas.",
    to: "/pais" as const,
  },
  {
    month: 8,
    title: "Chantagem virtual (sextortion)",
    desc: "Como agressores coagem crianças com ameaças de divulgação.",
    to: "/sinais" as const,
  },
  {
    month: 9,
    title: "Privacidade digital",
    desc: "O que sua família compartilha sem perceber e como proteger.",
    to: "/pais" as const,
  },
  {
    month: 10,
    title: "Inteligência artificial e deepfakes",
    desc: "Imagens íntimas falsas geradas por IA atingem menores no Brasil.",
    to: "/riscos-online" as const,
  },
  {
    month: 11,
    title: "Segurança nas férias",
    desc: "Mais tempo conectado, mais riscos. Combinados claros funcionam.",
    to: "/pais" as const,
  },
];
...
export function MonthlyAlert() {
  ...
  return (
    ...
    >
      <div
        className="absolute -right-16 -top-16 size-72 rounded-full bg-white/30 blur-3xl"
        aria-hidden
      />
